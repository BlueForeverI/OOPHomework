...
namespace GeometryAPI
{
                ...
                case "area":
                    {
                        ...
                        {
                            // display area
                            Console.WriteLine("{0:0.00}", (currentFigure as IAreaMeasurable).GetArea());
                        }
                        else
                        {
                            // figure has no area
                ...
                case "normal":
                    {
                        ...
                        {
                            Console.WriteLine((currentFigure as IFlat).GetNormal().ToString());
                        }
                        else
                        {
                            Console.WriteLine("undefined");
                ...
                case "volume":
                    {
                        ...
                        {
                            // display volume
                            Console.WriteLine("{0:0.00}", (currentFigure as IVolumeMeasurable).GetVolume());
                        }
                        else
                        {
                            // figure has no volume
                            Console.WriteLine("undefined");
                        }
    ...
    /// </summary>
    public class Circle : Figure, IFlat, ILengthMeasurable, IAreaMeasurable
    {
        // properties
    ...
    public class Cylinder : Figure,  IAreaMeasurable, IVolumeMeasurable
    {
        // properties
        public double Radius { get; private set; }
        public Vector3D BottomCenter { get; private set; }
